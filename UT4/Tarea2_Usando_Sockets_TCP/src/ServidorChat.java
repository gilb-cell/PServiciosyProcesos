    ...
    public static void main(String[] args)  {
       ...
       final int puerto= 12345;
        ...
        try( ServerSocket serverSocket = new ServerSocket(puerto)){
            System.out.println("El servidor esta inciado. Esperando conexion" + puerto);
            ...
            while(true){
                ...
                System.out.println("El cliente esta conectado" + socketCliente.getInetAddress().getHostName() +
                        socketCliente.getInetAddress().getHostAddress()); //Los get para que nos den mas informacion
                ...
                try(BufferedReader entrada = new BufferedReader(new InputStreamReader(socketCliente.getInputStream()));
                   ...
                   while ((mensajeCliente = entrada.readLine()) != null){
                       ...
                       String respuesta = "Mensaje recibido del cliente. Este es su mensaje: " + mensajeCliente;
                    ...
                    socketCliente.close();
                    System.err.println("Cliente finalizado desde: " + socketCliente.getInetAddress().getHostAddress());
                }
